<template>
  ...
  >
    ...
    <div class="mt-3 mb-2">
      Legen Sie fest, wann die VM(s) heruntergefahren und wann sie automatisch
      wieder gestartet werden soll(en):
    </div>
    ...
    <v-form ref="form">
      ...
      <common-time-picker
        ...
        :time-rules="[
          validationRules.notEmptyRule(
            'Ausschaltzeitpunkt darf nicht leer sein.'
          ),
      ...
      <common-time-picker
        ...
        :time-rules="[
          validationRules.notEmptyRule(
            'Einschaltzeitpunkt darf nicht leer sein.'
          ),
          validationRules.isNotPastTime(
            new Date(),
            startDate,
          ...
          () =>
            isStartAfterStop ||
            'Der Einschaltzeitpunkt muss nach dem Ausschaltzeitpunkt liegen.',
        ]"
      />
    </v-form>
  </common-dialog>
