      ...
      <v-card-text class="pt-4">
        ...
        >
          <div class="text-body-1">
            <strong
              >Diese Anwendung befindet sich aktuell in der Testphase!</strong
            >
          </div>
        </v-alert>
        ...
        <div class="text-body-1">
          <p class="mb-3">
            Bitte beachtet, dass sich die MCMP derzeit in der Entwicklungs- und
            Testphase befindet. Während dieser Phase kann es zu Änderungen,
            fehlenden Funktionen oder unerwarteten Fehlern kommen.
          </p>
          ...
          <ul class="mb-5 ml-6">
            ...
            <li>
              Bearbeitungen sind aktuell nur an C/K-Systemen möglich, sofern
              entsprechende Berechtigungen für den Application Service vorhanden
              sind.
            </li>
            <li>
              Fehlender Application Service? Bitte über ServiceNow beantragen.
            </li>
          </ul>
          <p class="mb-3">
          ...
          <ul class="mb-5 ml-6">
            ...
            <li>
              Verlinkungen zur CMDB und checkmk sowie Infos zur Patchnight
            </li>
          </ul>
          <p class="mb-3">
            Wenden Sie sich gerne an das CMP-Team rund um Thomas Meier, Aaron
            Adler, Max Sedlmeier und Reiko Streng – per Mail oder über Webex.
          </p>
          <p class="mb-0">
